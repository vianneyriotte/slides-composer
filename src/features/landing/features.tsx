const features = [
  {
    ...
    title: "Upload HTML",
    description: "Glissez-déposez vos fichiers HTML de présentation. Zéro configuration.",
  },
  {
    icon: (
    ...
    description: "Chaque présentation obtient une URL propre à partager avec votre audience.",
  },
  {
    icon: (
    ...
    title: "Standalone",
    description: "Fichiers HTML autonomes avec CSS/JS inline. Aucune dépendance externe.",
  },
];
